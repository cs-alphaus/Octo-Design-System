<template>
    <div>
        <div class="mb-8">
            <h1 class="text-2xl font-weight-bold mb-4">Dialog</h1>
        ...
        <div class="mb-8">
            <h2 class="text-2xl font-weight-medium mb-4">Confirmation dialogs</h2>
            ...
            <v-card class="mb-4">
                <v-card-text>
                    <div class="mb-4">
                        <p class="text-xs font-weight-medium mb-2">Colors (variant="tonal")</p>
            ...
            <!-- Dialog code -->
            <v-dialog v-model="confirmationDialogDemo" width="400" persistent>
                <v-card rounded="xl">
                    <!-- Title & Message -->
                    <div class="d-flex flex-column pa-6">
                        <p class="text-xl font-weight-medium mb-2">Delete item</p>
                        <p class="text-base message-text">Are you sure you want to delete this item? This action cannot be undone.</p>
                    </div>

                    <!-- Actions: Flexible equal width buttons (confirm takes priority if text is longer) -->
                    <v-card-actions class="pa-4 ga-2">
                        <v-btn class="confirm-cancel-btn" variant="tonal" @click="confirmationDialogDemo = false">Cancel</v-btn>
                        <v-btn class="confirm-primary-btn" variant="flat" color="error" @click="confirmationDialogDemo = false">Delete</v-btn>
                    </v-card-actions>
                </v-card>
            </v-dialog>
                ...
                <v-card-text class="pa-0">
                    ...
                    <v-expand-transition>
                        <div v-if="showDisplayCode">
                            <v-divider />
                            <pre class="pa-4 text-xs code-block" v-html="highlightedDisplayCode"></pre>
                        </div>
                    </v-expand-transition>
                </v-card-text>
            </v-card>
        ...
        <!-- Form Modal Dialog -->
        <div class="mb-8">
            <h2 class="text-2xl font-weight-medium mb-4">Medium size dialogs</h2>
            <p class="text-sm mb-4 text-medium-emphasis">
                A 560px width form dialog with header, content area, and action buttons. Suitable for forms with multiple fields and complex actions.
            </p>
            ...
            <v-card class="mb-4">
                <v-card-text>
                    <div class="mb-4">
                        <p class="text-xs font-weight-medium mb-2">Medium dialog (560px width)</p>
            ...
            <!-- Medium sized dialog -->
            <v-dialog v-model="formDialogDemo" width="560">
                <v-card rounded="xl">
                    <v-card-title class="d-flex align-center py-4 pr-3 pl-6">
                        ...
                        <v-spacer />
                        <v-chip prepend-icon="mdi-book-open-variant" rounded="lg" color="secondary" variant="tonal" size="small" density="default">
                            Read about how this optimization works
                        </v-chip>
                        <v-btn icon="$close" variant="text" @click="formDialogDemo = false" />
                    </v-card-title>
                    ...
                    <v-card-actions class="py-4 px-6">
                        <v-btn class="" @click="formDialogDemo = false" prepend-icon="mdi-close">Cancel</v-btn>
                        <v-spacer />
                        <v-btn class="" variant="tonal" color="primary" @click="formDialogDemo = false" prepend-icon="mdi-reload">Reset data</v-btn>
                        <v-btn class="" variant="flat" color="primary" @click="formDialogDemo = false" prepend-icon="mdi-check">Confirm</v-btn>
                    </v-card-actions>
                </v-card>
            </v-dialog>
            ...
            <v-card>
                <v-card-text class="pa-0">
                    <v-btn @click="showFormCode = !showFormCode" variant="text" prepend-icon="mdi-code-tags"
                        class="ma-4">
                        {{ showFormCode ? 'Hide code' : 'Show code' }}
                    </v-btn>

                    <v-expand-transition>
                        <div v-if="showFormCode">
                            <v-divider />
                            <pre class="pa-4 text-xs code-block" v-html="highlightedFormCode"></pre>
                        </div>
                    </v-expand-transition>
                </v-card-text>
            </v-card>
        ...
        <!-- Large Dialog -->
        <div class="mb-8">
            <h2 class="text-2xl font-weight-medium mb-4">Large dialogs</h2>
            <p class="text-sm mb-4 text-medium-emphasis">
                An 800px width dialog for complex forms with multiple sections or detailed content.
            </p>
            ...
            <v-card class="mb-4">
                <v-card-text>
                    <div class="mb-4">
                        <p class="text-xs font-weight-medium mb-2">Large dialog (800px width)</p>
            ...
            <!-- Large sized dialog -->
            <v-dialog v-model="largeDialogDemo" width="800">
                <v-card rounded="xl">
                    <v-card-title class="d-flex align-center py-4 pr-3 pl-6">
                        <v-icon icon="mdi-cog" class="mr-3" />
                        <span class="text-2xl">Settings</span>
                        <v-spacer />
                        <v-btn icon="$close" variant="text" @click="largeDialogDemo = false" />
                    </v-card-title>
                    ...
                    <v-card-actions class="py-4 px-6">
                        <v-btn prepend-icon="mdi-close" @click="largeDialogDemo = false">Cancel</v-btn>
                        <v-spacer />
                        <v-btn prepend-icon="mdi-reload" variant="tonal" color="primary" @click="largeDialogDemo = false">
                            Reset
                        </v-btn>
                        <v-btn prepend-icon="mdi-check" variant="flat" color="primary" @click="largeDialogDemo = false">
                            Save Changes
                        </v-btn>
                    </v-card-actions>
                </v-card>
            ...
            <v-card>
                <v-card-text class="pa-0">
                    <v-btn @click="showLargeCode = !showLargeCode" variant="text" prepend-icon="mdi-code-tags"
                        class="ma-4">
                        {{ showLargeCode ? 'Hide code' : 'Show code' }}
                    </v-btn>

                    <v-expand-transition>
                        <div v-if="showLargeCode">
                            <v-divider />
                            <pre class="pa-4 text-xs code-block" v-html="highlightedLargeCode"></pre>
                        </div>
                    </v-expand-transition>
                </v-card-text>
            </v-card>
        ...
        <!-- X-Large Dialog -->
        <div class="mb-8">
            <h2 class="text-2xl font-weight-medium mb-4">X-Large dialogs</h2>
            <p class="text-sm mb-4 text-medium-emphasis">
                A 1000px width dialog for comprehensive forms with multi-column layouts or extensive content.
            </p>
            ...
            <v-card class="mb-4">
                <v-card-text>
                    <div class="mb-4">
                        <p class="text-xs font-weight-medium mb-2">X-Large dialog (1000px width)</p>
            ...
            <!-- X-Large sized dialog -->
            <v-dialog v-model="xlargeDialogDemo" width="1000">
                <v-card rounded="xl">
                    <v-card-title class="d-flex align-center py-4 pr-3 pl-6">
                        <v-icon icon="mdi-file-document-edit" class="mr-3" />
                        <span class="text-2xl">Create New Project</span>
                        <v-spacer />
                        <v-btn icon="$close" variant="text" @click="xlargeDialogDemo = false" />
                    </v-card-title>
                    ...
                    <v-card-actions class="py-4 px-6">
                        <v-btn prepend-icon="mdi-close" @click="xlargeDialogDemo = false">Cancel</v-btn>
                        <v-spacer />
                        <v-btn prepend-icon="mdi-content-save-outline" variant="tonal" color="primary" @click="xlargeDialogDemo = false">
                            Save as Draft
                        </v-btn>
                        <v-btn prepend-icon="mdi-check-circle" variant="flat" color="primary" @click="xlargeDialogDemo = false">
                            Create Project
                        </v-btn>
                    </v-card-actions>
                </v-card>
            ...
            <v-card>
                <v-card-text class="pa-0">
                    <v-btn @click="showXLargeCode = !showXLargeCode" variant="text" prepend-icon="mdi-code-tags"
                        class="ma-4">
                        {{ showXLargeCode ? 'Hide code' : 'Show code' }}
                    </v-btn>

                    <v-expand-transition>
                        <div v-if="showXLargeCode">
                            <v-divider />
                            <pre class="pa-4 text-xs code-block" v-html="highlightedXLargeCode"></pre>
                        </div>
                    </v-expand-transition>
                </v-card-text>
            </v-card>
        ...
        <!-- Overflow Dialog -->
        <div class="mb-8">
            <h2 class="text-2xl font-weight-medium mb-4">Overflow dialogs</h2>
            <p class="text-sm mb-4 text-medium-emphasis">
                A dialog with scrollable content area when content exceeds the viewport height. Uses max-height and overflow-y for scrolling.
            </p>
            ...
            <v-card class="mb-4">
                <v-card-text>
                    <div class="mb-4">
                        <p class="text-xs font-weight-medium mb-2">Dialog with overflow content (560px width)</p>
            ...
            <!-- Overflow dialog -->
            <v-dialog v-model="overflowDialogDemo" width="560">
                <v-card rounded="xl">
                    <v-card-title class="d-flex align-center py-4 pr-3 pl-6">
                        <v-icon icon="mdi-file-document" class="mr-3" />
                        <span class="text-2xl">Terms and Conditions</span>
                        <v-spacer />
                        <v-btn icon="$close" variant="text" @click="overflowDialogDemo = false" />
                    </v-card-title>
                    ...
                    <v-card-actions class="py-4 px-6">
                        <v-btn prepend-icon="mdi-close" @click="overflowDialogDemo = false">Decline</v-btn>
                        <v-spacer />
                        <v-btn prepend-icon="mdi-check" variant="flat" color="primary" @click="overflowDialogDemo = false">
                            Accept
                        </v-btn>
                    </v-card-actions>
                </v-card>
            ...
            <v-card>
                <v-card-text class="pa-0">
                    <v-btn @click="showOverflowCode = !showOverflowCode" variant="text" prepend-icon="mdi-code-tags"
                        class="ma-4">
                        {{ showOverflowCode ? 'Hide code' : 'Show code' }}
                    </v-btn>

                    <v-expand-transition>
                        <div v-if="showOverflowCode">
                            <v-divider />
                            <pre class="pa-4 text-xs code-block" v-html="highlightedOverflowCode"></pre>
                        </div>
                    </v-expand-transition>
                </v-card-text>
            </v-card>
        ...
        <div class="mb-8">
            <h2 class="text-2xl font-weight-medium mb-4">Single action dialogs</h2>
            <p class="text-sm mb-4 text-medium-emphasis">
                A dialog with a single action button, typically used for notifications or information displays.
            </p>
            ...
            <v-card class="mb-4">
                <v-card-text>
                    <div class="mb-4">
                        <p class="text-xs font-weight-medium mb-2">Dialog with single action (560px width)</p>
            ...
            <!-- Single button dialog -->
            <v-dialog v-model="singleButtonDialogDemo" width="560">
                <v-card rounded="xl">
                    <v-card-title class="d-flex align-center py-4 pr-3 pl-6">
                        <v-icon icon="mdi-information" class="mr-3" />
                        <span class="text-2xl">System Update</span>
                        <v-spacer />
                        <v-btn icon="$close" variant="text" @click="singleButtonDialogDemo = false" />
                    </v-card-title>
                    ...
                    <v-card-actions class="py-4 px-6">
                        <v-btn block prepend-icon="mdi-check" variant="tonal" color="secondary" @click="singleButtonDialogDemo = false">
                            Got it
                        </v-btn>
                    </v-card-actions>
                </v-card>
            ...
            <v-card>
                <v-card-text class="pa-0">
                    <v-btn @click="showSingleButtonCode = !showSingleButtonCode" variant="text" prepend-icon="mdi-code-tags"
                        class="ma-4">
                        {{ showSingleButtonCode ? 'Hide code' : 'Show code' }}
                    </v-btn>

                    <v-expand-transition>
                        <div v-if="showSingleButtonCode">
                            <v-divider />
                            <pre class="pa-4 text-xs code-block" v-html="highlightedSingleButtonCode"></pre>
                        </div>
                    </v-expand-transition>
                </v-card-text>
            </v-card>
...
const showFormCode = ref(false)
const largeDialogDemo = ref(false)
const showLargeCode = ref(false)
const xlargeDialogDemo = ref(false)
const showXLargeCode = ref(false)
const overflowDialogDemo = ref(false)
const showOverflowCode = ref(false)
const singleButtonDialogDemo = ref(false)
const showSingleButtonCode = ref(false)
...
/* Flexible button sizing matching ConfirmationDialog component */
.confirm-cancel-btn {
  flex: 1 2 0;
  min-width: 0;
  white-space: normal;
